...
class Problem extends Model
{
    ...
    protected function diffProgramLanguage(): Attribute
    {
        return Attribute::make(
            get: fn (?string $value) => is_null($value) ? null : LanguagesType::name(intval($value)),
        );
    }
    ...
    {
        return $this->hasMany(TestCase::class)->chaperone();
    }
    ...
    {
        if ($category != null) {
            return $this->hasMany(Rank::class)->where('category', $category);
        }
