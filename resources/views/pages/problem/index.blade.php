                    ...
                    <td class="px-2">
                        <div class="hstack gap-1">
                            @can('view', $problem)
                                ...
                                @endif
                                <div class="vr"></div>
                                <a href="{{ route('problem.testCase.index', ['problem' => $problem->id]) }}" title="Test cases"
                                    class="d-flex action-btn">
                            ...
                            @can('update', $problem)
                                <div class="vr"></div>
                                <a href="{{ route('problem.scorer.index', ['problem' => $problem->id]) }}" title="Edit scorers"
                                    class="d-flex action-btn">
                                ...
                                <div class="vr"></div>
                                <a href="{{ route('problem.edit', ['problem' => $problem->id]) }}" title="Edit this problem"
                                    class="d-flex action-btn">
