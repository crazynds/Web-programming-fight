        ...
        <script>
            ...
            `)
                ...
                $('.notJudged').each(function(_, obj) {
                    const func = function() {
                        $.get('{{ route('api.submitRun.result', ['submitRun' => -1]) }}'.replace('-1', $(
                                obj)
                                ...
                                const geraResultado = function() {
                                    ...
                                    switch (data.result) {
                                        ...
                                        case 'Wrong answer':
                                            ...
                                            $(obj).find("#testCases").text(data.testCases)
                                            $(obj).find("#testCases").css('color', '#a00')
                                            break;
                                        case 'Time limit':
                                        case 'Memory limit':
                                            $(obj).find("#result").css('color', '#00a')
                                            $(obj).find("#testCases").text(data.testCases)
                                            $(obj).find("#testCases").css('color', '#00a')
                                            break;
                                        case 'Accepted':
                                            $(obj).find("#result").css('color', '#0a0')
                                            confeti();
                                            $(obj).find("#testCases").text('All');
                                            $(obj).find("#testCases").css('color', '#0a0')
                                            break;
                                        default:
                                    }
                                }
