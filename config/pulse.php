    ...
    'recorders' => [
        Recorders\CacheInteractions::class => [
            ...
            'groups' => [
                ...
                '/^resubmission:.*/' => 'ratelimit:*',
                '/^scores:reavaliate:.*/' => 'ratelimit:*',
        ...
        Recorders\SlowRequests::class => [
            ...
            'sample_rate' => env('PULSE_SLOW_REQUESTS_SAMPLE_RATE', 0.3),
        ...
        \PauloHortelan\RequestsGraphPulse\Recorders\RequestsGraphRecorder::class => [
            ...
            'sample_rate' => env('PULSE_REQUESTS_GRAPH_SAMPLE_RATE', 0.3),
